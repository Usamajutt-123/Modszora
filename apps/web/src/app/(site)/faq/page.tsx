...
const FAQS = [
  ...
  { question: 'Do I need an account to download?', answer: 'No. MODSzora has no public user registration at all. There are no surveys, no link shorteners and no paywalls \u2014 the countdown on the download page exists only to finish verifying the file.' },
  ...
  { question: 'Does MODSzora host the APK files?', answer: 'No. Files are transferred directly to third-party cloud storage (Mega) via remote upload and served from there. We index and verify; we do not operate the file hosting.' },
];
